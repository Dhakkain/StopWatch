...
intellisense.annotate(jQuery.Event.prototype, {
  ...
  'timeStamp': function() {
    /// <summary>The difference in ms between the time the browser created the event and January 1, 1970.</summary>
    /// <returns type="Number" />
  },
  'type': function() {
...
intellisense.annotate(jQuery.fn, {
  ...
  'delay': function() {
    ...
    ///   <param name="duration" type="Number">An integer indicating the number of ms to delay execution of the next item in the queue.</param>
    ///   <param name="queueName" type="String">A string containing the name of the queue. Defaults to fx, the standard effects queue.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
